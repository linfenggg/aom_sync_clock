module CW_TOP_WRAPPER(jtdi, jtck, jrstn, jscan, jshift, jupdate, jtdo, trig_clk, bus_din, wt_ce, wt_en, wt_addr);
	...
	localparam BUS_NUM = 10;
	localparam BUS_DIN_NUM = 66;
	localparam BUS_CTRL_NUM = 172;
	localparam integer BUS_WIDTH[0:9] = {1,16,4,3,16,4,1,1,16,4};
	localparam integer BUS_DIN_POS[0:9] = {0,1,17,21,24,40,44,45,46,62};
	localparam integer BUS_CTRL_POS[0:9] = {0,6,42,54,64,100,112,118,124,160};
